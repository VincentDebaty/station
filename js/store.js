...
function migrate(raw) {
  ...
  // PIERRE SE DÉPENSAIT (economie-du-jeu.md §4), avec `passeesEnPierres` par
  // carte et `achats.diamants`. Vincent : « pas une bonne idée ». Le schéma 9
  ...
  if (raw && (raw.version === 6 || raw.version === 7 || raw.version === 8 || raw.version === 9) && raw.cartes && typeof raw.cartes === "object") {
    ...
    return { version: SCHEMA_VERSION, carteCourante: raw.carteCourante || CARTE_PAR_DEFAUT, cartes, possedees,
      possessions: lirePossessions(raw) };
  }
