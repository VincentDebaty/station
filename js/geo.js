  ...
  countries: {
    ...
    "italie": { name: "Italie", flag: "🇮🇹", iso: "IT", continent: "europe",
      cities: {
        ...
        battipaglia: [14.9831, 40.6057],
        potenza: [15.8064, 40.6294],
        metaponto: [16.8152, 40.3684],
        taranto: [17.2242, 40.4835],
        bari: [16.87, 41.1181],
        salerno: [14.7724, 40.6754],
        paola: [16.0331, 39.3594],
        lamezia: [16.2556, 38.9211],
