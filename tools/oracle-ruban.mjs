...
function mixte(def, graine) {
  ...
  for (const g of ordreDe(def)) {
    ...
    else if (r < 0.70) { passees.push(g); stations[g] = { stars: 3, bestDelay: 0 }; }   // payée, puis gagnée sans faute
  }
...
function scenarios(carteId) {
  ...
  const debut = { stations: {}, passees: [ordre[7], ordre[8]], serie: { n: 2, record: 3 } };
  ...
  // le premier chapitre du complet est de diamant : 500 pièces de plus
