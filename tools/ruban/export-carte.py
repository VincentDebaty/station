...
PREMIER = int(sys.argv[1]) if len(sys.argv) > 1 else 32
DERNIER = int(sys.argv[2]) if len(sys.argv) > 2 else 58
...
ZONES = [
  {"id": "alpes", "nom": "L'arc méditerranéen et les Alpes", "couleur": "#c084fc", "jusqua": 48},
...
PLANCHER = {32:1, 33:2, 34:2, 35:2, 36:2, 37:2, 38:2, 39:2, 40:2, 41:2, 42:2, 43:2, 44:2, 45:2, 46:2, 47:2, 48:3, 49:3, 50:3, 51:3, 52:3,
            53:4, 54:4, 55:4, 56:4, 57:4, 58:4}
...
ARRIVEE = {32: 3, 33: 4, 34: 4, 35: 4, 36: 4, 37: 4, 38: 4, 39: 4, 40: 4, 41: 4, 42: 4, 43: 4, 44: 4, 45: 4}
